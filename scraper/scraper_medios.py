...
KEYWORDS = {
    "circular": ["economia circular", "circularidad", "reutilizacion", "ecodiseno",
                 ...
                 "ecoce", "rep vidrio", "rep aluminio", "rep envases", "envase retornable",
    ...
    "energia": ["pemex", "cfe", "apagon", "tarifas electricas", "gasoducto",
                ...
                "cne", "comision nacional de energia", "sener", "asea",
                "almacenamiento de energia", "bess", "certificado de energia limpia",
                "sistema de informacion energetica", "contenido nacional"],
    ...
    "residuos": ["residuos", "relleno sanitario", "tiradero", "reciclaje",
                 ...
                 "resina pet", "resina hdpe", "botella pet", "envases pet",
                 "rep envases rigidos", "cofepris", "etiquetado"],
